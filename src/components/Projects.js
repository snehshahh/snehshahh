...
const PROJECTS = [
  ...
  {
    id: 'social-api',
    title: 'Social Platform API Integrations',
    role: 'Freelance · Backend & Integrations',
    period: 'Since 2023',
    gif: 'social-api.gif',
    alt: 'Screen recording of a social API integration dashboard showing authenticated accounts and synced content metrics.',
    description:
      'Integration work against the Meta Graph API and the TikTok API: OAuth onboarding for creator accounts, signed webhook verification, paginated content and metrics sync, and retry handling that keeps pipelines inside each platform rate limit instead of failing loudly.',
    tags: ['Meta Graph API', 'TikTok API', 'OAuth 2.0', 'Node.js', 'Webhooks'],
    link: '',
    linkLabel: '',
  },
  {
